...
const Villas = (props) => {
    ...
    const graphqlQuery= {
        query:`query riad_r($type_transaction:String!)
        {
        riad_r(sort:"created_at:desc", where:{type_transaction:$type_transaction})
        {
            id
            created_at
            updated_at
    ...
    return (
        <main className='home'>
            <Helmet>
                <title>IMMOALAOUI - Riads rénovaient</title>
                <meta
                    name='description'
                    content='Riad rénovaient page'
                />
            </Helmet>
